...
<Stack.Navigator
  screenOptions={{
    headerShown: false,
    gestureEnabled: true,                    // default: allow swipe-back on most screens
...
>
  ...
  {/* Final confirmation screens — no swipe-back allowed */}
  <Stack.Screen 
    name="ThankYou" 
    component={ThankYouScreen} 
    options={{ 
      gestureEnabled: false,           // ← disables swipe-back completely
      headerShown: false,
    }} 
  />
  <Stack.Screen 
    name="ThankYou1" 
    component={ThankYou1Screen} 
    options={{ 
      gestureEnabled: false,           // ← disables swipe-back completely
      headerShown: false,
    }} 
